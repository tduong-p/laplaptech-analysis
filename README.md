...
See [`QUICKSTART.md`](QUICKSTART.md) for local setup, environment variables, `dbt build`, and the GitHub Actions deployment configuration.
...
- [Quickstart: local setup and deployment](QUICKSTART.md)
